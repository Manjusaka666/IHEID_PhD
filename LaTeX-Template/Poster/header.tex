...
% \usepackage{svg} % enable only when the poster imports raw SVG files
\usepackage{multicol}
...
% \usepackage{transparent} % optional transparency support for graphics
\newcommand{\incfig}[1]{%
...
% Keep the standard AMS relation spacing for \implies.
