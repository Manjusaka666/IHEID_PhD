...
% upper and lower hemi-continuity are logically independent.
...
\begin{tikzpicture}[
	...
	\begin{scope}
		...
		\node[caption] at (0.66,-0.45) {$\varphi$: upper but not lower
			hemi-continuous at $x=1$};
	\end{scope}
	...
	\begin{scope}[shift={(1.9,0)}]
		...
		\node[caption] at (0.66,-0.45) {$\psi$: lower but not upper
			hemi-continuous at $x=1$};
	\end{scope}
	...
	\begin{scope}[shift={(3.8,0)}]
		...
		\node[caption] at (0.66,-0.45) {$\gamma$: continuous};
	\end{scope}
