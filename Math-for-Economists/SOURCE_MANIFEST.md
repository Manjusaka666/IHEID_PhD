...
| `Boyd-Convex Optimization.pdf` | 732 | Boyd and Vandenberghe, *Convex Optimization* | Sec. 2.5 (p. 46), 3.4 (p. 95), 5.4 (p. 237), 5.5 (p. 241), 5.6 (p. 249) | High. Separation, quasiconvexity, saddle points, optimality conditions, sensitivity | 9, 12 | Yes. Note: this file has no usable text layer; its contents were read from page images, and only section titles and page numbers verified visually are cited |
